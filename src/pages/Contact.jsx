...
const Contact = () => {
  ...
  return (
    ...
    <ToastContainer
      ...
      <form className='flex flex-col 2xl:w-1/3 w-4/5 m-20 bg-white p-14 sm:p-8 drop-shadow-md shadow-[0_10px_16px_0_rgba(0,0,0,0.2),_0_6px_20px_0_rgba(0,0,0,0.19)]' onSubmit={sendEmail}>
        <div className='flex flex-col lg:flex-row gap-10'>
          <span className="flex flex-col lg:w-1/2 sm:w-full">
