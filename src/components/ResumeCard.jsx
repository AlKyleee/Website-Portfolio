...
const ResumeCard = ({ duration, positionName, companyDegree, location, children }) => {
    return (
        <div id='resumeCard' className='flex flex-col lg:flex-row px-14 py-28 sm:p-8 my-7 bg-white w-full gap-5 justify-between shadow-[0_10px_16px_0_rgba(0,0,0,0.2),_0_6px_20px_0_rgba(0,0,0,0.19)]'>
