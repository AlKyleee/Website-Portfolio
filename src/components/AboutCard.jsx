...
const AboutCard = () => {
    return (
        <div className='flex flex-col lg:flex-row p-5 lg:p-0 static lg:absolute w-full lg:h-3/4 h-full justify-center items-center z-10'>
            ...
            <div className='flex flex-col lg:pl-8 lg:w-2/5 xl:w-[30%] 2xl:w-1/5 w-full pt-8 items-center lg:items-start'>
                <p className='py-4 text-tertiary text-7xl font-semibold text-center lg:text-start'>{getTime()}</p>
                <p className='py-4 text-2xl font-semibold text-tertiary text-center lg:text-start'>Here's who I am & what I do</p>
                <div className='flex gap-2 py-4 justify-center lg:justify-start'>
                    ...
                    <Link to='/portfolio'><button className='rounded-full bg-tertiary text-white font-medium py-2 w-32 text-sm ease-in duration-300 border border-tertiary hover:text-tertiary hover:bg-white hover:border-sky-800'>PORTFOLIO</button></Link>
                </div>
                <p className='py-4 text-tertiary font-semibold text-center lg:text-left w-[90%] lg:w-full'>I am a graduate of Bachelor of Science in Information Technology Major in Web and Mobile Development in University of Santo Tomas and I am seeking clients to work with, wherein I can showcase my knowledge and skills for continuous improvement.</p>
            </div>
